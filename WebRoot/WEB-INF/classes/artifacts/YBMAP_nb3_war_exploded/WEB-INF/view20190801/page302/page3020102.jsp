...
<div id="dlg-panel" class="easyui-panel" title="信息文字内容">
	<form id="form30201" class="dlg-form" method="post" action="success.html" novalidate="novalidate">
		<table class="container">
			...
			<tr>
				<th><label for="detail">消息摘要：</label></th>
			...
			<tr>
				<th><label for="pusMessageType">消息类型：</label></th>
				<td><input id="pusMessageType" name="pusMessageType" class="easyui-combobox" required="required" style="width:250px;" data-options="multiple:true"/></td>
			</tr>
		</table>		
