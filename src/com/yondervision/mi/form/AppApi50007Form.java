...
public class AppApi50007Form extends AppApiCommonForm{
	...
	public String getWorkSheetLogVo() {
		return WorkSheetLogVo;
	}

	public void setWorkSheetLogVo(String workSheetLogVo) {
		WorkSheetLogVo = workSheetLogVo;
	}
	...
	public void setCsfnsrsbh(String csfnsrsbh) {
	...
	private String sydwTycode;//统一社会信用代码
...
//===========  株洲新加================
	...
	public void setSydwTycode(String sydwTycode) {
