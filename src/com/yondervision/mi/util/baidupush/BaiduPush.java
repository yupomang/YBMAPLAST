package com.yondervision.mi.util.baidupush;
...
public class BaiduPush {
	...
	public String PushNotify(String title, String message, String customDictionary, String userid) {
		RestApi ra = new RestApi(RestApi.METHOD_PUSH_MESSAGE);
		...
		String msg = String.format("{'title':'%s','description':'%s','notification_builder_id':0,'notification_basic_style':1,'open_type':2,'custom_content':%s}", title, jsonencode(message),customDictionary);
	...
	public String PushNotify(String title, String message) {
		RestApi ra = new RestApi(RestApi.METHOD_PUSH_MESSAGE);
		ra.put(RestApi._MESSAGE_TYPE, RestApi.MESSAGE_TYPE_NOTIFY);
