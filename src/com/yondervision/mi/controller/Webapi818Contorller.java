...
public class Webapi818Contorller {
    ...
    public Map<String, String> webapi80018(AppApi00240Form form, HttpServletRequest request, HttpServletResponse response) throws Exception {

        form.setBusinName("webapi80018--公积金缴存明细查询打印");
