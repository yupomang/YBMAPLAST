...
public class Webapi820Contorller {
    ...
    public Map<String, String> webapi80020(AppApi00240Form form, HttpServletRequest request, HttpServletResponse response) throws Exception {

        form.setBusinName("webapi80020--公积金贷款明细查询打印");
        Logger log = LoggerUtil.getLogger();
        log.info(ERRCODE.LOG.START_BUSIN.getLogText(form.getBusinName()));
        long starTime = System.currentTimeMillis();
        log.info("webapi80020--form.getUnitaccname()======" + form.getSpt_ywid());
        ...
        System.out.println("webapi80020--请求耗时" + Time + "毫秒");
        return map;
    }
}
