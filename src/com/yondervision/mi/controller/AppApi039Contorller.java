...
/** 
* @ClassName: AppApi039Contorller 
* @Description: 单位业务_个人封存
* @author Caozhongyan
...
public class AppApi039Contorller {
	...
	public String appapi03901(AppApi030Form form,  ModelMap modelMap, HttpServletRequest request, 
...
//		pc.check(form);
	...
	public String appapi03902(AppApi030Form form,  ModelMap modelMap, HttpServletRequest request, 
			HttpServletResponse response) throws Exception{
		Logger log = LoggerUtil.getLogger();
		form.setBusinName("单位业务—封存启封信息查询");	
		log.info(LOG.START_BUSIN.getLogText(form.getBusinName()));
		log.debug(DEBUG.SHOW_PARAM.getLogText(CommonUtil
				.getStringParams(form)));
		ApiUserContext.getInstance();
