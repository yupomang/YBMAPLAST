...
import com.yondervision.mi.dao.*;
...
@Controller
public class insertMi098Controller {
	private Logger log = LoggerUtil.getLogger();

    @RequestMapping("/webapiInsertMi098.json")
    public void insertMi098(String centerid, String date1, String date2, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        Mi098DAO mi098Dao = (Mi098DAO) com.yondervision.mi.util.SpringContextUtil.getBean("mi098Dao");
        Mi007DAO mi007Dao = (Mi007DAO) com.yondervision.mi.util.SpringContextUtil.getBean("mi007Dao");

        log.info("transday=" + date1);
        ...
        //信息查询类，不包含文件下载
        List<HashMap> list1 = cmi099Dao.selectSearchInfo(date1, date2);
		for(int i=0; i<list1.size(); i++){
			insertMi098(list1.get(i), "1");
		}

        List<HashMap> list2 = cmi098Dao.selectAppointment(date1, date2);
