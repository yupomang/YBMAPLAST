...
@Controller
public class AppApi00339Contorller {
    ...
    public String appapi00339(AppApi00239Form form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        form.setBusinName("appapi00339--公积金个人缴存账户查询打印");
        Logger log = LoggerUtil.getLogger();
        log.info(ERRCODE.LOG.START_BUSIN.getLogText(form.getBusinName()));
        long starTime = System.currentTimeMillis();
        log.info("appapi00339--form.getAccnum()======" + form.getAccnum());
        log.info("appapi00339--form.getSpt_indiaccstatename()======" + form.getSpt_indiaccstatename());
        log.info("appapi00339--form.getBasenum()======" + form.getBasenum());
        log.info("appapi00339--form.getBal()======" + form.getBal());
        log.info("appapi00339--form.getBal1()======" + form.getBal1());
        log.info("appapi00339--form.getIndipaysum()======" + form.getIndipaysum());
        log.info("appapi00339--form.getLpaym()======" + form.getLpaym());
        log.info("appapi00339--form.getOpnaccdate()======" + form.getOpnaccdate());
        log.info("appapi00339--form.getUnitaccname()======" + form.getUnitaccname());
        ...
        log.info("appapi00339----生成doc文件路径: " + templateFile.split(".doc"));
        ...
        //盖章
        log.info("appapi00339----doc文件转PDF文件--完成");
        String fileName = form.getCertinum() + "_" + saleContractNo+"-grzhjbxx";
        log.info("appapi00339---文件fileName===========" + fileName);
        System.out.println("appapi00339---生成pdf文件结束");
        if (pdfFile == null) {
        ...
        if (errmassage.equals("成功")){
            ...
            log.info("appapi00339---对pdf文件进行Base64加密===========");
            ...
            log.info("appapi00339---json1==========="+json1.toString());
            ...
            System.out.println("appapi00339--请求耗时" + Time + "毫秒");
            return json1.toString();
