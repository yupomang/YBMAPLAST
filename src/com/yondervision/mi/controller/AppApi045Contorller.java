...
/** 
* @ClassName: AppApi045Contorller 
* @Description: 单位业务_补缴登记
* @author Caozhongyan
...
public class AppApi045Contorller {
	...
	public String appapi04501(AppApi030Form form,  ModelMap modelMap, HttpServletRequest request, 
			HttpServletResponse response) throws Exception{
		Logger log = LoggerUtil.getLogger();
		form.setBusinName("单位业务_补缴登记");	
...
//		pc.check(form);
	...
	public String appapi04502(AppApi030Form form,  ModelMap modelMap, HttpServletRequest request, 
			HttpServletResponse response) throws Exception{
		Logger log = LoggerUtil.getLogger();
		form.setBusinName("公积金登记撤销");	
		log.info(LOG.START_BUSIN.getLogText(form.getBusinName()));
		log.debug(DEBUG.SHOW_PARAM.getLogText(CommonUtil
				.getStringParams(form)));
		ApiUserContext.getInstance();
	...
	public String appapi04503(AppApi030Form form,  ModelMap modelMap, HttpServletRequest request, 
			HttpServletResponse response) throws Exception{
		Logger log = LoggerUtil.getLogger();
		form.setBusinName("单位业务_补缴登记");	
		log.info(LOG.START_BUSIN.getLogText(form.getBusinName()));
