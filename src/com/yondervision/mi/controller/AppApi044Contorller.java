...
/** 
* @ClassName: AppApi044Contorller 
* @Description: 单位业务_汇缴登记
* @author Caozhongyan
...
public class AppApi044Contorller {
	...
	public String appapi04401(AppApi030Form form,  ModelMap modelMap, HttpServletRequest request, 
			HttpServletResponse response) throws Exception{
		Logger log = LoggerUtil.getLogger();
		form.setBusinName("单位业务_汇缴登记");	
...
//		pc.check(form);
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/appapi04402.{ext}")
	public String appapi04402(AppApi030Form form,  ModelMap modelMap, HttpServletRequest request, 
			HttpServletResponse response) throws Exception{
		Logger log = LoggerUtil.getLogger();
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/appapi04403.{ext}")
	public String appapi04403(AppApi030Form form,  ModelMap modelMap, HttpServletRequest request, 
			HttpServletResponse response) throws Exception{
		Logger log = LoggerUtil.getLogger();
		form.setBusinName("单位业务_预缴登记");	
		log.info(LOG.START_BUSIN.getLogText(form.getBusinName()));
		log.debug(DEBUG.SHOW_PARAM.getLogText(CommonUtil
				.getStringParams(form)));
		ApiUserContext.getInstance();
