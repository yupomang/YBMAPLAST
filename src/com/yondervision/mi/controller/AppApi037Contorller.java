...
/** 
* @ClassName: AppApi037Contorller 
* @Description: 单位业务_单位资料变更
* @author Caozhongyan
...
public class AppApi037Contorller {
	...
	public String appapi03701(AppApi030Form form,  ModelMap modelMap, HttpServletRequest request, 
			HttpServletResponse response) throws Exception{
		Logger log = LoggerUtil.getLogger();
		form.setBusinName("单位资料变更");	
...
//		pc.check(form);
	...
	public String appapi03702(AppApi030Form form,  ModelMap modelMap, HttpServletRequest request, 
			HttpServletResponse response) throws Exception{
		Logger log = LoggerUtil.getLogger();
		form.setBusinName("单位资料变更查询");	
		log.info(LOG.START_BUSIN.getLogText(form.getBusinName()));
