 ...
 *
 */
public class Page70701TreeResult {
	/** 树节点ID **/
	private String id;
	/** 树节点名称 **/
	private String text;
	...
	/** 子节点 **/
	List<Page70701TreeResult> children;
	 ...
	 * @return the children
	 */
	public List<Page70701TreeResult> getChildren() {
		return children;
	}
	 ...
	 */
	public void setChildren(List<Page70701TreeResult> children) {
