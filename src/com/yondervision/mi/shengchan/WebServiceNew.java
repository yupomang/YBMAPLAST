...
public class WebServiceNew {
	public static void RPCClient() {
		...
		options.setAction("http://www.hzhnkj.com.cn/getTicket");// 调用接口方法
		...
		try {  
			...
			name.setText("330211196011230033");// 设置入参值  
			method.addChild(name);
			...
			method.addChild(name1);  
			OMElement name2 = fac.createOMElement("sfzh", omNs);// 设置入参名称 
			name2.setText("330211196011230033");// 设置入参值  
			method.addChild(name2);
	...
	public static void main(String[] args) throws UnknownHostException {  
		//RPCClient();
		OMElement omElement = WebServiceClient("http://172.16.10.159:88/pdjhwebservice/Service.asmx",
