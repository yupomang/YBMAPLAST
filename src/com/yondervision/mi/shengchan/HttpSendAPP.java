...
public class HttpSendAPP {
	...
	private static final String userId_V = "330204199001061029";
...
//			unitaccnum = aes.encrypt(unitaccnum.getBytes("UTF-8"));
	...
	//			userId = aes.encrypt(accnum.getBytes("UTF-8"));
	//		}
			userId = aes.encrypt("330204199001061029".getBytes("UTF-8"));
			String appKey = aes.encrypt(appKey_V.getBytes("UTF-8"));
			String appId = aes.encrypt(appId_V.getBytes("UTF-8"));
	 ...
	 * "330204199001061029","cardno":"",
	 * "bodyCardNumber":"330204199001061029","certinum"
	 * :"330204199001061029","msg":"成功","accnum":"0127664948"}
	 */
...
//		System.out.println(" 个人公积金登录验证 用身份证号时 logintype赋值2 公积金账号 logintype赋值5");
		httpURLConnectionPOST5432("2", "330204199001061029", "", "111111");
//		httpURLConnectionPOST5432("5", "", "0127664948", "111111");
//		
//		//个人公积金密码修改
//		System.out.println(" 个人公积金密码修改");
//		httpURLConnectionPOST5448("330204199001061029", "", "111111", "111111");
//		httpURLConnectionPOST5448("", "0127664948", "111111", "111111");
//
//		//个人账户查询
//		System.out.println("个人账户查询");
//		httpURLConnectionPOST5001("330204199001061029", "", "111111");
//		httpURLConnectionPOST5001("", "0127664948", "111111");
//
//		//贷款审批情况查询
//		System.out.println("贷款审批情况查询");
//		httpURLConnectionPOST5445("330204199001061029", "", "111111");
//		httpURLConnectionPOST5445("", "0127664948", "111111");
//
//		//贷款余额信息查询
//		System.out.println("贷款余额信息查询");
//		httpURLConnectionPOST5073("330204199001061029", "", "111111");
