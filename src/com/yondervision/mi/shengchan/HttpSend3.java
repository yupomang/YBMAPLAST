	...
	*/
	public static void httpURLConnectionPOST () {  
		try {  
			...
			connection.addRequestProperty("headpara", "centerId,userId,usertype,deviceType,deviceToken,currenVersion,buzType,devtoken,channel,appid,appkey,appToken,clientIp,accessToken,tpl_id");
 ...
 * dataMap.put("appKey", "2a12813db3135c7515805c31e29c2206d2a3800c");
	...
	dataMap.put("platform", "web");*/
			...
			//3、用于数字签名			
			String parm ="centerId=00057400&userId="+userId+"&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5754&devtoken=&channel=50&appid="+appId+"&appkey="+appKey+"&appToken=&clientIp=DJv9mNfY9qPBA/x6cL6iFQ==&accessToken=vGZG9UcfBNuVOjYdFk9iZWQ4ZjMyOTMyMGI3NDQ4MmJjN2ZkOTUyZWE5N2I0NjkR08XVHlVevjpY3OSCeFr0da7xxW&tpl_id=68";
			//3、用于发送http报文
			String parm1 ="centerId=00057400&userId="+userId.replace("+","%2B")+"&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5754&devtoken=&channel=50&appid="+appId.replace("+", "%2B")+"&appkey="+appKey.replace("+", "%2B")+"&appToken=&clientIp=DJv9mNfY9qPBA/x6cL6iFQ==&accessToken=vGZG9UcfBNuVOjYdFk9iZWQ4ZjMyOTMyMGI3NDQ4MmJjN2ZkOTUyZWE5N2I0NjkR08XVHlVevjpY3OSCeFr0da7xxW&tpl_id=68";
