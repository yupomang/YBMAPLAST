...
public class TestHttp {
	...
	public static void main(String[] args) throws Exception{
		...
		System.out.println("孙燕波");
		System.out.println(reqstr);
		String url="http://61.153.144.77:7006/YBMAPZH/webapi80005.json";//替换ip跟端口号，网站的ip端口
		String ret=send(url,"POST",reqstr,null);
		System.out.println(ret);
		System.out.println(RSAUtil.decrypt(ret));
		/*String aa="zhlx     一般公积金,xm张鹏程                                  ";
		System.out.println(RSAUtil.encrypt(aa));
		String b=RSAUtil.encrypt(aa);
		System.out.println(RSAUtil.decrypt(b));*/
	}
