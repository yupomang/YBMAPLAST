...
public class HttpSendAPP {
	public static final String POST_URL = "http://61.153.144.77:7006/YBMAPZH/";

	private static final String userId_V = "330682199408031287";
	private static final String appKey_V = "c5c013922801a1c1d705763ce61117ed";
	private static final String appId_V = "yondervisionapp10";
	...
	public static String httpURLConnectionPOST5448(String certinum,
		...
		try {
			...
			String parm = "centerId=00057400&userId="
					+ userId
					+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5448&devtoken=&channel=10&appid="
					+ appId
					+ "&appkey="
					+ appKey
	...
	public static String httpURLConnectionPOST5463(String unitaccnum,
		...
		try {
			...
			String parm = "centerId=00057400&userId="
					+ userId
					+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5463&devtoken=&channel=10&appid="
					+ appId
					+ "&appkey="
					+ appKey
	...
	public static String httpURLConnectionPOST5001(String certinum,
		...
		try {
			...
			String userId = "";
			userId = aes.encrypt("330682199408031287".getBytes("UTF-8"));
			String appKey = aes.encrypt(appKey_V.getBytes("UTF-8"));
			String appId = aes.encrypt(appId_V.getBytes("UTF-8"));
			pwd = aes.encrypt(pwd.getBytes("UTF-8"));
			String parm = "";
			if (null != certinum && !"".equals(certinum)) {
				parm = "centerId=00057400&userId="
						+ userId
						+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5001&devtoken=&channel=10&appid="
						+ appId
						+ "&appkey="
						+ appKey
						+ "&appToken=&clientIp=DJv9mNfY9qPBA/x6cL6iFQ==&bodyCardNumber="
	 ...
	 * "330682199408031287","cardno":"",
	 * "bodyCardNumber":"330682199408031287","certinum"
	 * :"330682199408031287","msg":"成功","accnum":"0127664948"}
	 */
	public static String httpURLConnectionPOST5432(String logintype,
		...
		try {
			...
			if (null != certinum && !"".equals(certinum)) {
				...
				parm = "centerId=00057400&userId="
						+ userId
						+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5432&devtoken=&channel=10&appid="
						+ appId
						+ "&appkey="
						+ appKey
						+ "&appToken=&clientIp=DJv9mNfY9qPBA/x6cL6iFQ==&bodyCardNumber="
...
//			}
			...
			if (null != certinum && !"".equals(certinum)) {
				...
				parm = "centerId=00057400&userId="
						+ userId
						+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5445&devtoken=&channel=10&appid="
						+ appId
						+ "&appkey="
						+ appKey
						+ "&appToken=&clientIp=DJv9mNfY9qPBA/x6cL6iFQ==&bodyCardNumber="
	...
	//		}
			...
			if (null != certinum && !"".equals(certinum)) {
				...
				parm = "centerId=00057400&userId="
						+ userId
						+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5073&devtoken=&channel=10&appid="
						+ appId
						+ "&appkey="
						+ appKey
						+ "&appToken=&clientIp=DJv9mNfY9qPBA/x6cL6iFQ==&bodyCardNumber="
	...
	public static String httpURLConnectionPOST5461(String unitaccnum, String pwd) {
		try {
			...
			String parm = "centerId=00057400&userId="
					+ userId
					+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5461&devtoken=&channel=10&appid="
					+ appId
					+ "&appkey="
					+ appKey
					+ "&appToken=&clientIp=DJv9mNfY9qPBA/x6cL6iFQ==&unitaccnum="
	...
	public static String httpURLConnectionPOST5801(String unitaccnum, String pwd) {
		try {
			...
			String parm = "centerId=00057400&userId="
					+ userId
					+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5801&devtoken=&channel=10&appid="
					+ appId
					+ "&appkey="
					+ appKey
					+ "&appToken=&clientIp=DJv9mNfY9qPBA/x6cL6iFQ==&unitaccnum="
	 ...
	 * 
	 */
	public static String httpURLConnectionPOST5010(String certinum,
			String accnum, String pwd) {
		try {
			URL url = new URL(POST_URL + "appapi00122.json");
			HttpURLConnection connection = (HttpURLConnection) url.openConnection();
			connection.setDoOutput(true);
			connection.setDoInput(true);
			connection.setRequestMethod("POST");
			...
			if (null != certinum && !"".equals(certinum)) {
				parm = "centerId=00057400&userId="
						+ userId
						+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5010&devtoken=&channel=10&appid="
						+ appId
						+ "&appkey="
						+ appKey
						+ "&appToken=&clientIp=DJv9mNfY9qPBA/x6cL6iFQ==&bodyCardNumber="
...
//		httpURLConnectionPOST5432("5", "", "0076458492", "123456");
	...
	//		httpURLConnectionPOST5448("330682199408031287", "", "111111", "111111");
	//		httpURLConnectionPOST5448("", "0127664948", "111111", "111111");
	//
	//个人账户查询
	//		System.out.println("个人账户查询");
//			httpURLConnectionPOST5001("330682199408031287", "", "111111");
	//		httpURLConnectionPOST5001("", "0127664948", "111111");

//		//贷款审批情况查询
//		System.out.println("贷款审批情况查询");
//		httpURLConnectionPOST5445("330682199408031287", "", "111111");
//		httpURLConnectionPOST5445("", "0127664948", "111111");

//		//贷款余额信息查询
//		System.out.println("贷款余额信息查询");
//		httpURLConnectionPOST5073("330682199408031287", "", "111111");
//		httpURLConnectionPOST5073("", "0127664948", "111111");
...
//		httpURLConnectionPOST5010("330682199408031287", "", "111111");
