package com.yondervision.mi.test.jianhangzizhuzhongduan;
...
public class AesTestJiianHangZiZhu {
...
//	private final String CIPHERMODEPADDING = "AES/CBC/PKCS7Padding";
	...
	public AesTestJiianHangZiZhu() throws Exception {
		try {
			char[] key = "789bg42pqAd4kG9x".toCharArray(); 	     //	建行手机银行测试
...
//			System.out.println(key);
	...
	public static void main(String[] args) throws TransRuntimeErrorException, UnsupportedEncodingException {
		AesTestJiianHangZiZhu aes=null;
		try {
			aes = new AesTestJiianHangZiZhu();
		} catch (Exception e) {
			e.printStackTrace();
		}
		...
		String w ="";
