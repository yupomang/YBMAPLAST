...
//	private final String CIPHERMODEPADDING = "AES/CBC/PKCS7Padding";
	...
	public AesTest() throws Exception {
		try {
			//注意更改秘钥
//			char[] key = "01pcaijsmkefgG3d".toCharArray(); 		//APP
//			char[] key = "ppo1922JjT4hwY6h".toCharArray(); 		//微信
//			char[] key = "03WrW99WrZ3trE1a".toCharArray(); 		//民政局
//			char[] key = "0JkI72jIsU1xoI1j".toCharArray(); 		    //自助终端
//			char[] key = "06QsKWLM210cwD8e".toCharArray(); 	//服务热线	
//			char[] key = "07JbE01CqXiqW1jc".toCharArray();
//			char[] key = "08YcP13BaM19Ijwl".toCharArray(); 		
////			char[] key = "789bg42pqAd4kG9x".toCharArray(); 	//建行客户端s
//			char[] key = "oszi52ynixujp4zv".toCharArray(); 	     //	网厅生产
			char[] key = "042bH21pqad2kG8x".toCharArray(); 	     //	网厅测试
			//char[] key = "03EkE87ijfe36T2s".toCharArray(); //	网站生产
			//char[] key = "jn9dcr59gfld17xa".toCharArray(); 	     //宁波银行手机银行测试
//			char[] key = "h4hxyujsdns1vaea".toCharArray(); 	     //	工行
//			char[] key = "05Xd318IsU1xoI1j".toCharArray(); 	     //	衢州自助
//			char[] key = "789bg42pqAd4kG9x".toCharArray(); 	     //	建行客户端测试
//			char[] key = "6okj31tjlnw8kt8e".toCharArray(); 	     //	建行客户端生产
//			char[] key = "axur6bkwyq2u3h4m".toCharArray(); 	     //	建行手机银行测试//宁波市里统一的自助终端自助终端
//			char[] key = "jn9dcr59gfld17xa".toCharArray(); 	     //	宁波银行手机银行测试
//			char[] key = "axur6bkwyq2u3h4m".toCharArray(); 	     //	中国银行手机银行测试
//			char[] key = "icvv8985p32qjdx4".toCharArray(); 	     //	政务机器人测试
//			char[] key = "zn1253mt5amzqp41".toCharArray(); 	     //	政务机器人生产
