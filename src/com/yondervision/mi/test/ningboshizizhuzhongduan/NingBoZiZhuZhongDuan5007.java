...
public class NingBoZiZhuZhongDuan5007 {
	...
	public static String httpURLConnectionPOST5900(String certinum,String accnum) {
		try {
			...
			+ userId
			+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5007&devtoken=&channel=53&appid="
			+ appId
			+ "&appkey="
			+ appKey
	...
	public static void main(String[] args) throws UnknownHostException, UnsupportedEncodingException {
		...
		*/
		httpURLConnectionPOST5900("232332199711205129","");
		httpURLConnectionPOST5900("330224197511216023","");
		httpURLConnectionPOST5900("330903198409183625","");
