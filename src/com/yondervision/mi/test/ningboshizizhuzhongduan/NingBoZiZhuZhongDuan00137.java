...
public class NingBoZiZhuZhongDuan00137 {
	...
	public static String httpURLConnectionPOST5021(
			String certinum,String accname,
			String powerMatters,
			String subPowerMatters,
			String materialName
	) {
		try {
			URL url = new URL(POST_URL + "appapi00137.json");
			...
			parm = "centerId=00057400&userId="
					+ userId
					+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5992&devtoken=&channel=53&appid="
					+ appId
					+ "&appkey="
					+ appKey
	...
	public static void main(String[] args) throws UnknownHostException, UnsupportedEncodingException {
		httpURLConnectionPOST5021("410527199207155021","赵晓然", "","","");
	}
}
