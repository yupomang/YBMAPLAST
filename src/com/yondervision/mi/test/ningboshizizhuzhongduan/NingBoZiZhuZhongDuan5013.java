...
public class NingBoZiZhuZhongDuan5013 {
	...
	public static String httpURLConnectionPOST5002(String accnum,String indiacctype, String startdate,String enddate) {
		...
		try {
			...
			String userId = aes.encrypt("612301197005102656".getBytes("UTF-8"));
			String appKey = aes.encrypt(appKey_V.getBytes("UTF-8"));
			String appId = aes.encrypt(appId_V.getBytes("UTF-8"));
			String parm = "";
			// 用于数字签名
			parm = "centerId=00057400&userId="
					+ userId
					+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5002&devtoken=&channel=53&appid="
					+ appId
					+ "&appkey="
					+ appKey
					+ "&appToken=&clientIp=DJv9mNfY9qPBA/x6cL6iFQ==&accnum="
...
/*	通知公告*/
	...
	public static String httpURLConnectionPOST5013(String 	bankcode,String 	buyhousecerid,
		...
		try {
			...
			String parm ="centerId=00057400&userId="
			+ userId
			+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5013&devtoken=&channel=53&appid="
			+ appId
			+ "&appkey="
			+ appKey
			+ "&appToken=&clientIp=172.10.0.1&brcCode=05740008";
...
//		httpURLConnectionPOST5432("2", "330726198810170330", "", "111111");
//		httpURLConnectionPOST5432("5", "", "0237724982", "111111");
//		httpURLConnectionPOST5432("5", "", "0114662694", "111111");
//		httpURLConnectionPOST5432("5", "", "0076458492", "111111");
...
//		System.out.println("个人账户查询");
	/*	httpURLConnectionPOST5001("330726198810170330", "", "");
		httpURLConnectionPOST5001("", "0076458492", "");*/

		//贷款审批情况查询
//		System.out.println("贷款审批情况查询");
//		httpURLConnectionPOST5445("370784198503076054", "", "");
...
//		httpURLConnectionPOST5073("330227198910245423", "", "");
...
//		httpURLConnectionPOST5021("0076458492","1","2015-12-12","2017-12-12","0","","");
/*		(String accnum,String indiacctype,
				String startdate,String enddate,
				String ispaging,String pageflag,
				String pagenum)*/
...
/*		//通知公告及正文内容获取
		...
		//httpURLConnectionPOST5013("0011","330206198211060030",URLEncoder.encode("袁辉","utf-8"),"1");
		httpURLConnectionPOST5013("0003","130185199302101325",URLEncoder.encode("张娜","utf-8"),"1");

		//httpURLConnectionPOST5013("0003","330203197911081816",URLEncoder.encode("张大可","utf-8"),"1");
		//
		//httpURLConnectionPOST5013("0006","332528197008144425",URLEncoder.encode("蔡陈香","utf-8"),"1");
		//httpURLConnectionPOST5013("0006","330225197902061571",URLEncoder.encode("樊勇","utf-8"),"1");
	}
