...
public class NingBoZiZhuZhongDuan5474 {
	...
	public static String httpURLConnectionPOST5900(String accnum,String tel) {
		try {
			...
			+ userId
			+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5474&devtoken=&channel=53&appid="
			+ appId
			+ "&appkey="
			+ appKey
	...
	public static void main(String[] args) throws UnknownHostException, UnsupportedEncodingException {
		...
		*/
		httpURLConnectionPOST5900("0238136602","17681808295");
