...
public class NingBoZiZhuZhongDuan00221 {
	...
	public static String httpURLConnectionPOST5021(
		...
		try {
			...
			parm = "centerId=00057400&userId="
					+ userId
					+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=6019&devtoken=&channel=53&appid="
					+ appId
					+ "&appkey="
					+ appKey
	...
	public static void main(String[] args) throws UnknownHostException, UnsupportedEncodingException {
		httpURLConnectionPOST5021("55862105X");
	}
}
