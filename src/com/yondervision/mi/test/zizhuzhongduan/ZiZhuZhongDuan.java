...
public class ZiZhuZhongDuan {

	public static final String POST_URL = "http://61.153.144.77:7001/YBMAPZH/";

//	private static final String userId_V = "330683198602047823";
	private static final String appKey_V = "f53de13df5bf0d043c64467187a23759";
	private static final String appId_V = "yondervisionselfservice50";
	...
	public static String httpURLConnectionPOST5448(String certinum,
		...
		try {
			...
			connection
					.addRequestProperty(
							"headpara",
							"centerId,userId,usertype,deviceType,deviceToken,currenVersion,buzType,devtoken,channel,appid,,appToken,clientIp,bodyCardNumber,password,newpassword,confirmnewpassword,accnum");
			...
			String parm = "centerId=00057400&userId="
					+ userId
					+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5448&devtoken=&channel=50&appid="
					+ appId
					+ "&appkey="
					+ appKey
	...
	public static String httpURLConnectionPOST5001(String certinum,String accnum, String pwd) {
		try {
			...
			String parm = "centerId=00057400&userId="+ userId
						+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5001&devtoken=&channel=50&appid="
						+ appId+ "&appkey="+ appKey
	 ...
	 * "330726198810170330","cardno":"",
	 * "bodyCardNumber":"330726198810170330","certinum"
	 * :"330726198810170330","msg":"成功","accnum":"0076458492"}
	 */
		...
		try {
			...
			if (null != certinum && !"".equals(certinum)) {
				...
				parm = "centerId=00057400&userId="
						+ userId
						+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5432&devtoken=&channel=50&appid="
						+ appId
						+ "&appkey="
						+ appKey
						+ "&appToken=&clientIp=DJv9mNfY9qPBA/x6cL6iFQ==&bodyCardNumber="
	...
	public static String httpURLConnectionPOST5445(String certinum,
		...
		try {
			...
			if (null != certinum && !"".equals(certinum)) {
				...
				parm = "centerId=00057400&userId="
						+ userId
						+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5445&devtoken=&channel=50&appid="
						+ appId
						+ "&appkey="
						+ appKey
						+ "&appToken=&clientIp=DJv9mNfY9qPBA/x6cL6iFQ==&bodyCardNumber="
	...
	//		}
			...
			if (null != certinum && !"".equals(certinum)) {
				...
				parm = "centerId=00057400&userId="
						+ userId
						+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5073&devtoken=&channel=50&appid="
						+ appId
						+ "&appkey="
						+ appKey
	...
	public static String httpURLConnectionPOST5914(String accnum,String qdapprnum, String projectname) {
		...
		try {
			...
			parm = "centerId=00057400&userId="
					+ userId
					+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5914&devtoken=&channel=50&appid="
					+ appId
					+ "&appkey="
					+ appKey
					+ "&appToken=&clientIp=DJv9mNfY9qPBA/x6cL6iFQ==&accnum="
	...
	public static String httpURLConnectionPOST5002(String accnum,String indiacctype, String startdate,String enddate) {

		try {
			URL url = new URL(POST_URL + "appapi00201.json");
			HttpURLConnection connection = (HttpURLConnection) url.openConnection();
			connection.setDoOutput(true);
			connection.setDoInput(true);
			connection.setRequestMethod("POST");
			connection.setUseCaches(false);
			connection.setInstanceFollowRedirects(true);
			connection.addRequestProperty("headpara","centerId,userId,usertype,deviceType,deviceToken,currenVersion,buzType,devtoken,channel,appid,appkey,appToken,clientIp,accnum,indiacctype");
			AesTestZiZhu aes = null;
			try {
				aes = new AesTestZiZhu();
			} catch (Exception e) {
			...
			parm = "centerId=00057400&userId="
					+ userId
					+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5002&devtoken=&channel=50&appid="
					+ appId
					+ "&appkey="
					+ appKey
					+ "&appToken=&clientIp=DJv9mNfY9qPBA/x6cL6iFQ==&accnum="
					+ accnum + "&indiacctype=" + indiacctype;
			...
			String parm1 = "centerId=00057400&userId="
					...
					+ appKey.replace("+", "%2B")
					+ "&appToken=&clientIp=DJv9mNfY9qPBA/x6cL6iFQ==&accnum="
					+ accnum.replace("+", "%2B") + "&indiacctype="
					+ indiacctype.replace("+", "%2B")+"&startdate="+startdate.replace("+","%2B")+"&enddate="+enddate.replace("+","%2B");
			System.out.println("parm" + parm);
			System.out.println("parm1" + parm1);
			connection.addRequestProperty("headparaMD5", RSASignature.sign(
					EncryptionByMD5.getMD5(parm.getBytes()),RSASignature.RSA_PRIVATE));
...
//			String userId = aes.encrypt("330726198810170330".getBytes("UTF-8"));
			...
			parm = "centerId=00057400&userId="
					+ userId
					+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5021&devtoken=&channel=50&appid="
					+ appId
					+ "&appkey="
					+ appKey
...
/*	通知公告*/
	public static String httpURLConnectionPOST5521(String classification,String pagenum,String pagerows) {
		try {
			...
			parm = "centerId=00057400&userId="
					+ userId
					+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5521&devtoken=&channel=50&appid="
					+ appId
					+ "&appkey="
					+ appKey
	...
	public static String httpURLConnectionPOST5525(String classification,String pagenum, String pagerows) {
		try {
			...
			parm = "centerId=00057400&userId="
					+ userId
					+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5525&devtoken=&channel=50&appid="
					+ appId
					+ "&appkey="
					+ appKey
					+ "&appToken=&clientIp=172.10.0.1&brcCode=05740008";
	...
	public static String httpURLConnectionPOST5752(String strucid) {
		try {
			...
			parm = "centerId=00057400&userId="
					+ userId
					+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5752&devtoken=&channel=50&appid="
					+ appId
					+ "&appkey="
					+ appKey
					+ "&appToken=&clientIp=172.10.0.1&brcCode=05740008";
	...
	public static String httpURLConnectionPOST5973(
		...
		try {
			...
			parm = "centerId=00057400&userId="
					+ userId
					+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5973&devtoken=&channel=50&appid="
					+ appId
					+ "&appkey="
					+ appKey
					+ "&appToken=&clientIp=172.10.0.1&brcCode=05740008";
...
/*		classification=21&pagenum=1&pagerows=8
		String classification,String pagenum,String pagerows*/
//		httpURLConnectionPOST5521("21","0","8");
...
//		httpURLConnectionPOST5432("2", "330227197212075098", "", "");

		
//		httpURLConnectionPOST5432("2", "330203197310010019", "", "123456");
//		httpURLConnectionPOST5432("5", "", "0237724982", "111111");
//		httpURLConnectionPOST5432("5", "", "0114662694", "111111");	
...
//		httpURLConnectionPOST5445("330726198810170330", "", "");
//		httpURLConnectionPOST5445("", "0076458492", "123456");

		//贷款余额信息查询
//		System.out.println("贷款余额信息查询");
//		httpURLConnectionPOST5073("330683198602047823", "", "111111");
//		httpURLConnectionPOST5073("", "330726198810170330", "123456");

		//缴存证明打印
//		System.out.println("缴存证明打印");
//		String str = new String("13424".getBytes(),"UTF-8");
//		httpURLConnectionPOST5914("0076458492", "WT456788765435", str);
		
		//个人对账单查询
//		System.out.println("个人对账单查询");0076458492
		httpURLConnectionPOST5002("0076458492", "1", "2015-12-12","2017-12-12");
		
		
//		httpURLConnectionPOST5973("330726198810170330","张鹏程","其他-02491-000","其他-02491-005","出境定居提取住房公积金","沈磊","330203197310010019");

//		String accnum,String indiacctype, String startdate,String enddate
//		httpURLConnectionPOST5002("0114662694", "1", "2015-12-12","2017-12-12");
//		httpURLConnectionPOST5002("0046616737", "1", "2017-07-12","2018-01-12");
//		httpURLConnectionPOST5021("0237724982","1","","","","","");
