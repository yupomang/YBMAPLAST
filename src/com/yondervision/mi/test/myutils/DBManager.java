...
public class DBManager {
	 ...
	 * @throws IOException
	 * @throws Exception
	 *             声明drivers，得到数据库的驱动程序 声明url，得到连接远程数据库的URL
	 *             声明username，得到连接远程数据库的用户名 声明password，得到连接远程数据库的密码
	...
	public boolean executeUpdate(String sqlwords) {
		...
		try {
			...
			System.err
					.println("Execute Update Sql Failed!: " + ex.getMessage());
			return false;
		}
	}
	...
	public boolean executeInsert(String sqlwords) {
		...
		try {
			...
			System.err
					.println("Execute Insert Sql Failed!: " + ex.getMessage());
			return false;
		}
	}
	...
	public boolean executeDelete(String sqlwords) {
		...
		try {
			...
			System.err
					.println("Execute Delete Sql Failed!: " + ex.getMessage());
			return false;
		}
	}
	...
	/**
	 * 声明conn 声明rs结果集 声明stmt语气 声明sqlwords关键字
	 */
