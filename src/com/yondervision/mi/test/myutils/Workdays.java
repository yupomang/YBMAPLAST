...
/*对于任意2个日期比如：date_start=2006-10-1、date_end=2006-10-14 ，
 ...
 但是这个日期并不是我们所要的日期，接下来我们要做的就是计算date_start,date_end这两个日期
 对于根据它们所产生的新的日期之间的时间偏移量，date_start的偏移量（date_start_change）是需要加的，
 而date_end的这个偏移量（date_end_change）是需要减去的。 
