...
//省建设厅二手房转让合同接口
public class HttpSend5984appapi00145 {
	public static final String POST_URL = "http://61.153.144.77:7006/YBMAPZH/";
	private static final String appKey_V = "b5b1c6938e5d0cef72457bd788ffdef0";
	private static final String appId_V = "yondervisionwebservice40";
	private static final String clientIp_V="172.10.0.1";

	public static String httpURLConnectionPOST5984(String jgh,
																				String jkbm,
																				String certinum,
																				String SZCS,
																				String HTBH) {
		try {
			URL url = new URL(POST_URL + "appapi00145.json");
		 ...
		 String Para ="userId="+ userId+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5984&appid="
...
//		private String  jkbm;//接口编码 非加密 esfht
//		private String  certinum;//	certinum	房屋买受人证件号码
//		private String  SZCS;//	SZCS	所在城市行政编码
//		private String  HTBH;//	HTBH	合同编号
		httpURLConnectionPOST5984("11","esfht","330282199210120047","330200","2018330282MM0012075B");  
