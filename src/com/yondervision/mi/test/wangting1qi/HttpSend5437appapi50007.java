...
//个人账号密码重置
public class HttpSend5437appapi50007 {
	...
	public static String httpURLConnectionPOST5437(String bodyCardNumber,String fullName,String tel,String checkcode) {
		try {
		 ...
		 String Para ="userId="+ userId+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5437&appid="
						+ appId_V+ "&appkey="+ appKey_V+ "&appToken=&clientIp="+clientIp_V+"&clientMAC=E8:39:35:A7:AC:58&brcCode=05740008&tranDate=2017-09-19&channelSeq="
								+ "&bodyCardNumber="+bodyCardNumber+ "&fullName="+fullName+ "&tel="+tel+ "&checkcode="+checkcode;
	...
	public static void main(String[] args) throws UnknownHostException {
		httpURLConnectionPOST5437("330204197508036114","邵建宁","13362486339","358147");
