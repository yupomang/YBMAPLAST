...
public class HttpSend5725appapi07025 {
	...
	public static String httpURLConnectionPOST5725(String	accnum,
			...
			String	repaytolamt) {
		try {
			URL url = new URL(POST_URL + "appapi07025.json");
		 ...
		 String Para ="userId="+ userId+ "&usertype=10&deviceType=3&deviceToken=&currenVersion=1.0&buzType=5725&appid="
	...
	public static void main(String[] args) throws UnknownHostException {
		httpURLConnectionPOST5725("0237425912",
				"0",
				"SL00142017001556",
				"311",
				"1",
