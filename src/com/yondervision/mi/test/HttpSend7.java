	...
	*/
	public static void httpURLConnectionPOST () {  
		try {  
			...
			String appId = aes.encrypt("yondervisionapp10".getBytes("UTF-8"));
			String appKeyZH = aes.encrypt("c5c013922801a1c1d705763ce61117ed".getBytes("UTF-8"));
			...
			//用于数字签名
			String parm = "centerId=00057400&userId="+userId+"&usertype=10&deviceType=2&deviceToken=&currenVersion=1.0&buzType=5432&devtoken=&channel=10&appid="
					+appId+"&appkey="+appKeyZH+"&appToken=&clientIp="+clientIp+"&bodyCardNumber="+bodyCardNumber+"&password="+password+"&accnum="+accnum;
			//用于发送http报文
			String parm1 = "centerId=00057400&userId="+userId+"&usertype=10&deviceType=2&deviceToken=&currenVersion=1.0&buzType=5432&devtoken=&channel=10&appid="
					+appId+"&appkey="+appKeyZH+"&appToken=&clientIp="+clientIp+"&bodyCardNumber="+bodyCardNumber+"&password="+password+"&accnum="+accnum;
