...
//网点排队情况查询
public class HttpSend5516appapi10106 {
	...
	public static String httpURLConnectionPOST5516(String websitecode) {
		try {
			URL url = new URL(POST_URL + "appapi10106.json");
			...
			String userId = "330281199106034636";
			AesTest aes = null;
			try {
				aes = new AesTest();
			} catch (Exception e) {
...
//		positionX  121.555398,   positionY   29.874727
		httpURLConnectionPOST5516("0574000801");
